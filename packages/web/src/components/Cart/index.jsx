  ...
  return (
    <div className="cart">
      ...
      <div className="cart__footer">
        {items?.creator ? <div className="cart__footer-author" title="author">
        ...
        </div> : <div className="cart__footer-author" title="author" />}
        <div
        ...
        <div className="cart__footer-views" title={`${isDemo ? "0" : items?.rating.views} views`}>
